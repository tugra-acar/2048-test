...
void QTile::draw()
{
    if (tile == NULL) {
        ...
        case 4096: {
            ...
            dse->setOffset(-1);
            setGraphicsEffect(dse);
            setStyleSheet("QTile { background: rgb(160, 50, 160); color: rgb(255,255,255); font: bold; border-radius: 10px; font: 35pt; }");
            break;
        }
        case 8192: {
            QGraphicsDropShadowEffect *dse = new QGraphicsDropShadowEffect();
            ...
            dse->setOffset(-1);
            setGraphicsEffect(dse);
            setStyleSheet("QTile { background: rgb(130, 30, 130); color: rgb(255,255,255); font: bold; border-radius: 10px; font: 35pt; }");
            break;
        }
        default: {
            setStyleSheet("QTile { background: rgb(238,228,218); color: rgb(119,110,101); font: bold; border-radius: 10px; font: 40pt; }");
